      ...
      <div id="navfull" className="absolute px-4 translate-y-[-20rem] top-0 left-0 right-0 h-[20rem] bg-white dark:bg-black">
        <div className="pt-24 pr-2">
          <div className="flex flex-col items-start  justify-start text-2xl dark:text-white text-black text-[16px] font-medium">
            ...
            <a target="_blank" href="https://drive.google.com/file/d/15QuE0LCiFGbl9yFGKULiLx3i8HovDsP8/view?usp=sharing" className="mx-4 dark:hidden block">
              resume
            </a>
            <a target="_blank" href="https://drive.google.com/file/d/1SbXI0oSRh6WyP2HbSPk_4Y6HQ7sElezF/view?usp=sharing" className="mx-4 hidden dark:block">
              resume
            </a>
          </div>
        </div>
